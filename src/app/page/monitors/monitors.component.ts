...
@Component({
    selector: 'monitors-page',
    styleUrl: './monitors.component.css',
    templateUrl: './monitors.component.html'
})
export class Monitors implements OnInit {
    ...
    ngOnInit(): void {
        this.pagingHeader$.subscribe((value: PagingHeader | undefined) => {
            ...
            if(value != null) {
                this.productService.getMonitorsProductsWithPaging(value).subscribe((response: ApiResponse<PagingContent<Product>>) => {
                    if(response.success) {
